...
class Cutesy < Formula
  ...
  url "https://github.com/chasefinch/cutesy/archive/refs/tags/v1.0rc4.tar.gz"
  ...
  resource "data-enum" do
    url "https://files.pythonhosted.org/packages/source/d/data-enum/data_enum-3.0.1.tar.gz"
